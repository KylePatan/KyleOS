...
/// Schema version 33 — real-use bug/feature pass (Kyle, 2026-08-20, first day of putting real
/// work into the app): "there should be an archive in both writing and clips." Writing already had
/// one (`Project.isArchived`); this adds the Clips-side equivalent, `Source.isArchived`/
/// `archivedAt` — same optional, V8-lesson-safe shape as `Project`'s own fields.
///
/// All other models re-declared unchanged from V32 (see the note at the top of
/// KyleOSSchemaV2.swift for why this pattern matters).
enum KyleOSSchemaV33: VersionedSchema {
