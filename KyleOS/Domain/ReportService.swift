...
enum ReportService {
    ...
    typealias HistoryEvent = KyleOSSchemaV33.HistoryEvent
    typealias HistoryEventKind = KyleOSSchemaV33.HistoryEventKind
    ...
    typealias JokeStatus = KyleOSSchemaV33.JokeStatus
