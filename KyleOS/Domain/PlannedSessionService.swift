...
enum PlannedSessionService {
    typealias PlannedSession = KyleOSSchemaV10.PlannedSession
    typealias PlannedSessionStatus = KyleOSSchemaV10.PlannedSessionStatus
    typealias SessionOrigin = KyleOSSchemaV10.SessionOrigin
    typealias WorkItem = KyleOSSchemaV10.WorkItem
    typealias CalendarEvent = KyleOSSchemaV10.CalendarEvent
