...
enum CalendarEventService {
    typealias CalendarEvent = KyleOSSchemaV16.CalendarEvent
    typealias CalendarEventType = KyleOSSchemaV16.CalendarEventType
    typealias Availability = KyleOSSchemaV16.Availability
    typealias Project = KyleOSSchemaV16.Project
    typealias WorkItem = KyleOSSchemaV16.WorkItem
    typealias Deadline = KyleOSSchemaV16.Deadline
