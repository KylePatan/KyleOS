...
enum ScriptBlockService {
    typealias ScriptBlock = KyleOSSchemaV14.ScriptBlock
    typealias ScriptElementType = KyleOSSchemaV14.ScriptElementType
    typealias Document = KyleOSSchemaV14.Document
    ...
    private typealias SceneElementType = KyleOSSchemaV14.SceneLocationType
