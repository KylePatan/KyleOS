...
enum ScriptBlockService {
    typealias ScriptBlock = KyleOSSchemaV13.ScriptBlock
    typealias ScriptElementType = KyleOSSchemaV13.ScriptElementType
    typealias Document = KyleOSSchemaV13.Document
    ...
    private typealias SceneElementType = KyleOSSchemaV13.SceneLocationType
