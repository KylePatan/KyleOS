...
enum ScriptBlockService {
    typealias ScriptBlock = KyleOSSchemaV22.ScriptBlock
    typealias ScriptElementType = KyleOSSchemaV22.ScriptElementType
    ...
    private typealias SceneElementType = KyleOSSchemaV22.SceneLocationType
