...
enum ScriptBlockService {
    typealias ScriptBlock = KyleOSSchemaV27.ScriptBlock
    typealias ScriptElementType = KyleOSSchemaV27.ScriptElementType
    typealias Document = KyleOSSchemaV27.Document
    ...
    private typealias SceneElementType = KyleOSSchemaV27.SceneLocationType
