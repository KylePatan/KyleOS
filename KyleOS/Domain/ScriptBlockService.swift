...
enum ScriptBlockService {
    typealias ScriptBlock = KyleOSSchemaV31.ScriptBlock
    typealias ScriptElementType = KyleOSSchemaV31.ScriptElementType
    ...
    private typealias SceneElementType = KyleOSSchemaV31.SceneLocationType
