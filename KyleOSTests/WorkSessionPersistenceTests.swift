...
final class WorkSessionPersistenceTests: XCTestCase {
    ...
    func testDeletingWorkItemCascadesToItsWorkSessions() throws {
        ...
        let remaining = try context.fetch(FetchDescriptor<WorkSessionService.WorkSession>())
    ...
    func testDataSurvivesReopeningTheStore() throws {
        ...
        do {
            ...
            let context = ModelContext(container)
            let sessions = try context.fetch(FetchDescriptor<WorkSessionService.WorkSession>())
