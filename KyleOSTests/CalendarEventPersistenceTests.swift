...
final class CalendarEventPersistenceTests: XCTestCase {
    ...
    func testCreatingAnEventPersists() throws {
        ...
        let fetched = try context.fetch(FetchDescriptor<KyleOSSchemaV15.CalendarEvent>())
    ...
    func testDeletingLinkedProjectNullifiesRatherThanDeletingTheEvent() throws {
        ...
        let remaining = try context.fetch(FetchDescriptor<KyleOSSchemaV15.CalendarEvent>())
    ...
    func testDataSurvivesReopeningTheStore() throws {
        ...
        do {
            ...
            let context = ModelContext(container)
            let events = try context.fetch(FetchDescriptor<KyleOSSchemaV15.CalendarEvent>())
